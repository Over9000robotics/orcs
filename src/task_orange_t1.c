...
//		mission_go(-888, 147, 0x40, FORWARD);
	...
	{
		ignore_sensors(1);
		mission_go(-1304, 835, 0x40, FORWARD);
	...
	void mission9(void)
	{
		mission_go(-355,-377,0x45,FORWARD);
	}
	void mission10(void)
	{
		mission_go(-365,-765,0x45,FORWARD);
	}
	void mission11(void)
	{
		mission_wait(200);
